...
public class InventoryUpdateProduct extends javax.swing.JFrame {
    ...
    public InventoryUpdateProduct(int productId, String productName, String category, int quantity, int reorderLevel, String price, String expirationDate, String description, AdminView adminView) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(23)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtReorderLevel, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(25)
                    ...
                    .addComponent(jLabel5)
                    .addComponent(txtReorderLevel, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelDescription)
                ...
                .addGap(18)
                    ...
                    .addComponent(jLabel7)
                    .addComponent(txtExpirationDate, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel4)
        ...
        try {
            ...
            try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/storvendb", "root", "")) {
                PreparedStatement stmt = conn.prepareStatement(
                    "UPDATE inventory SET product_name=?, category=?, stock_level=?, reorder_level=?, price=?, expiration_date=?, description=? WHERE product_id=?");
                ...
                if (category.equalsIgnoreCase("Laundry & Cleaning Supplies")) {
                    stmt.setNull(6, java.sql.Types.DATE);
                } else {
                ...
                stmt.setInt(8, this.productId); // product ID to update
